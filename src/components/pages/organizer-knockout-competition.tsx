...
import KnockoutMatchCard from "../shared/competitions/knockout-match-card";
...
export default function OrganizerKnockoutCompetition({ competition, teams = [], rounds = [] }: KnockoutCompetitionProps) {
